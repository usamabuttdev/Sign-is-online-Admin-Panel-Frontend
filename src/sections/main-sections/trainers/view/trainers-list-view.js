...
const userList = [
  ...
  },
  {
    ...
    profileIcon: "https://borrowappbucket.s3.us-east-1.amazonaws.com/54be4663-f58f-4994-8d3f-933b9d46745a.jpg",
    name: "Saim",
...
export default function TrainersListView() {
  ...
  const {data , isLoading }=useGetAllusersListQuery({
    page: table.page + 1 ,
  ...
  const TABS = [
    {
      ...
      label: "All",
      color: "default",
      count: usersCount?.total || 0
    },
    {
      value: "active",
      label: "Active",
      color: "success",
      count: usersCount?.active || 0
    },
    {
      value: "suspended",
      label: "Suspended",
      color: "warning",
      count:  usersCount?.suspended || 0
    },
  ];
          ...
          >
            <CustomBreadcrumbs
              ...
              links={[
                ...
                { name: "Trainers", href: paths.dashboard.trainer.root },
              ]}
              sx={{
                mb: { xs: 3, md: 5 },
              }}

...
export default function AccountsProfileView() {
  ...
  const infoAccounts = {
      ...
      locationsList: [
        { loc_title: "New York", loc_date_inserted: "2025-06-01T10:30:00Z" },
        { loc_title: "Los Angeles", loc_date_inserted: "2025-07-15T14:00:00Z" },
        { loc_title: "Chicago", loc_date_inserted: "2025-08-10T09:00:00Z" },
      ],
  }

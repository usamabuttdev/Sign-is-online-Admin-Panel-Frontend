...
import { useGetAllTrainingModesQuery } from 'src/store/Reducer/training-modes';
...
export default function TrainingModesListView() {
  ...
  const {data ,isLoading}=useGetAllTrainingModesQuery({
    page: table.page + 1 ,
  ...
  const tagsCount = data?.meta?.tagsCount;
        ...
        <Container maxWidth={settings.themeStretch ? false : "lg"}>
            ...
            <CustomBreadcrumbs
              ...
              links={[
                ...
                { name: "Trainig Modes", href: paths.dashboard.trainingModes.root },
              ]}
              sx={{
                mb: { xs: 3, md: 5 },
              }}
